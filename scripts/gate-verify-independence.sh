#!/usr/bin/env bash
# gate-verify-independence.sh - role gate 6: verifier independence.
#
...
#
# Scans the repo for the two metadata-carrying artifact kinds:
#   * claims ledgers    (*.md with generator|verification|verifier columns)
#   * evidence bundles  (dirs with model.json + gates.json - the roles protocol)
#
